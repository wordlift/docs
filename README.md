...
The site exposes generated AI-consumable documentation indexes:

- `/llms.txt`
- `/llms-full.txt`

These files are generated by `docusaurus-plugin-llms-builder`, configured in `docusaurus.config.js`. After changing docs content that should be visible to AI tools, run a production build and verify the generated artifacts:
