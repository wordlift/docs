...
Install the [Agent WordLift Skill](./integrations.md#agent-wordlift-claude-skill) to give your host agent these workflows, the prompt library, SEO audits, and a verified GraphQL reference out of the box.
:::
